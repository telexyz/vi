...
def build_tokenizer(args):
    ...
    elif args.tokenizer_type.lower() == "symato":
        tokenizer = SymatoTokenizer()
    else:
...
class SymatoTokenizer(AbstractTokenizer):
    def __init__(self):
        name = "SymatoTokenizer"
        super().__init__(name)

        self.tokenizer = Symato()
        self.eod_id = None
        self.pad_id = None
    ...
    @property
    def vocab(self):
        raise NotImplementedError("Symato does not implement vocabulary access.")
