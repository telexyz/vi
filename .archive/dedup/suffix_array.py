# Source https://github.com/ChenghaoMou/text-dedup/blob/main/text_dedup/suffix_array.py
import argparse, os, random, subprocess, datasets
...
from add_args import add_io_args, add_meta_args, add_sa_args
