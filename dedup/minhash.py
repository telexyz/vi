# Source https://github.com/ChenghaoMou/text-dedup/blob/main/text_dedup/minhash.py

import argparse, gc, hashlib, os, pickle, random, re
...
def optimal_param(
    ...
    Examples
    --------
    >>> optimal_param(0.75, 256)           => (21, 12)
    >>> optimal_param(0.75, 256, 0.1, 0.9) => (28, 9)
    """
